  ...
  <app-layout>
    <div class="columns is-centered">
      <div class="column is-9-tablet is-9-desktop is-7-widescreen">
        <a class="back-link has-text-dark" @click="confirmClose"
          >&larr; Back to lesson</a
        >

        <div class="box p-5">
          <div
            class="mt-6 mb-5 is-flex is-align-items-center"
          ...
          >
            <b-input
              ...
              @input="isDirty = true"
              v-model="form.title"
              custom-class="no-resize p-0 f-0 is-size-2 has-text-weight-semibold is-borderless modal-card-title"
              style="width: 100%;"
        ...
        <div class="section-controls is-fixed-bottom py-3 has-background-white">
          <div
            class="container fields is-flex is-justify-content-flex-end is-align-content-center"
          >
            <b-checkbox @input="isDirty = true" v-model="form.is_chatroom"
...
import TranslateBlock from "@/components/editorjs/plugins/TranslateBlock";
    ...
    confirmClose() {
      if (this.isDirty) {
        this.$buefy.dialog.confirm({
          message:
            "<strong>Are you sure?</strong> Unsaved changes will be lost.",
          onConfirm: () =>
            this.$inertia.visit(
              route("lesson.edit", {
          ...
          config: {
            services: {
              ...
              soundcloud: {
                ...
                embedUrl:
                  "https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/<%= remote_id %>&color=33c2cf",
                html:
                  '<iframe style="width:100%;" height="166" frameborder="0"></iframe>',
                width: 600,
                height: 166
              }
            }
