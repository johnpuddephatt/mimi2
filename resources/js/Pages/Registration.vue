    ...
    <div class="columns is-centered">
      <div class="column is-7-tablet is-6-desktop is-5-widescreen">
        <div v-if="isRegistering" class="box register-form">
          <div v-if="!isRegistered">
            <h3 class="title has-text-centered">
              Un momento <span class="emoji">⌛</span>
            </h3>
            <p class="subtitle has-text-centered">This shouldn’t take long</p>
          </div>
          <div v-else>
            <h3 class="title has-text-centered">
              Congratulazioni <span class="emoji">👍</span>
            </h3>
        ...
        <form ref="form" v-else class="box register-form">
          <h3 class="title has-text-centered">
            Ti diamo il benvenuto <span class="emoji">👋</span>
          </h3>
          <p class="subtitle has-text-centered">
          ...
          >
            <b-step-item label="Account" :clickable="true">
              <b-field
                ...
                :type="errors.first_name ? 'is-danger' : null"
              >
                <b-input
                  required
                  name="first_name"
              ...
              <b-field
                ...
                :type="errors.last_name ? 'is-danger' : null"
              >
                <b-input
                  required
                  name="last_name"
              ...
              <b-field label="Introduce yourself">
                <b-input
                  ...
                  rows="4"
                  required
                  placeholder="Introduce yourself to the other students."
                >
                </b-input>
              </b-field>
            ...
            <b-step-item label="Notifications" :clickable="true">
              <b-field label="Email notifications">
                <div class="mb-5">
                  ...
                  <b-checkbox
                    v-for="(value, key) in notification_emails"
                    :key="key"
...
export default {
  props: ["errors", "cohort", "admin", "notification_emails"],
  components: {
    AppLayout,
    CameraField
  },
