  ...
  <div class="column is-12-tablet is-12-desktop is-9-widescreen">
    ...
    <form ref="form" class="box p-0 register-form is-relative columns">
      ...
      <div class="column has-background-white-bis p-6 portrait-p-3">
        ...
        <ul class="mt-6">
          <li class="is-flex mb-2"><b-icon class="mr-1" type="is-success" icon="checkbox-marked-circle-outline"/><p class="is-size-7 mt-1">Enjoy a new Italian lesson every day</p></li>
          <li class="is-flex is-size-7 mb-2"><b-icon class="mr-1" type="is-success" icon="checkbox-marked-circle-outline"/><p class="mt-1">Take part in live weekly conversation practice</p></li>
          <li class="is-flex is-size-7"><b-icon class="mr-1" type="is-success" icon="checkbox-marked-circle-outline"/><p class="mt-1">Receive personalised feedback from Italian teachers</p></li>
        </ul>
