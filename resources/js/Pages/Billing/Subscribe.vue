    ...
    <div class="column is-12-tablet is-12-desktop is-9-widescreen">
      ...
      <form ref="form" class="box p-0 register-form is-relative columns">
        ...
        <div class="column has-background-white-bis p-6 portrait-p-3">
          ...
          <ul class="mt-6">
            <li class="is-flex is-size-6 mb-2"><b-icon class="mr-1" type="is-success" icon="check-circle"/><p>Enjoy a new Italian lesson every day</p></li>
            <li class="is-flex is-size-6 mb-2"><b-icon class="mr-1" type="is-success" icon="check-circle"/><p>Take part in live weekly conversation practice</p></li>
            <li class="is-flex is-size-6"><b-icon class="mr-1" type="is-success" icon="check-circle"/><p>Receive personalised feedback from Italian teachers</p></li>
          </ul>
