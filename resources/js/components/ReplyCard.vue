<template>
  <transition name="fade-out">
    <div v-if="!isDeleted" class="column is-full is-half-widescreen is-relative">
        ...
        <div class="modal-card">
          <header class="modal-card-head is-radiusless">
            <div class="reply-author" @click="isUserModalOpen = true">
              ...
              <p>
                <span class="is-size-6">{{ reply.user.first_name }}</span>
                <span class="is-size-7"><timeago :datetime="reply.video.converted_for_streaming_at" :auto-update="60"></timeago></span>
              </p>
            </div>
               ...
               <div class="card-content">
                   <div class="media ">
                       ...
                       <div class="media-content">
                           ...
                           <br><p><small>Joined <timeago :datetime="reply.user.created_at"></timeago></small></p>
                       </div>
                   </div>
               </div>
           </div>
